...
2. **Generate protobuf**: Once we have the nsys profile generated, we pass it to the python script provided [here [generate_pbtxt.py]](../../../../rosetta/utils/generate_pbtxt.py) to generate the pbtxt file. A sample pbtxt file would look like this:
```
...
